tell application "System Events"
		...
		display alert "Web eID Uninstaller" message "This will uninstall Web eID. Please give us feedback why you uninstalled" as critical buttons {"Cancel", "Uninstall"} default button "Uninstall"
